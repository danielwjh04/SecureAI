 ...
 * module is typed against the structural {@link ParserConfig} slice it needs,
 * which the full `ScannerConfig` satisfies.
 */

import { ParseError } from '../errors'

/**
 * The slice of `ScannerConfig` the parser depends on. The full config object
